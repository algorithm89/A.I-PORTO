...
![Scalar, vector, matrix, tensor — one number, a row of numbers, a grid, and a stack of grids.](cast.png)
...
![The vector [3, 4]: walk 3 right and 4 up. Every list of numbers is secretly an arrow.](vector-arrow.png)
